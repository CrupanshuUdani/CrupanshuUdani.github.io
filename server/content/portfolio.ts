 ...
 *
 * To update the site later, edit this file and restart/redeploy the app.
 * Keep public-facing links in profile.links or project.links.
 * Add, remove, or reorder cards by changing the arrays below; the frontend
 * renders sections dynamically from /api/portfolio.
 */
export const portfolio: Portfolio = {
  ...
  maintenance: {
    contentModel: "Backend-served modular portfolio data",
    editHint:
      "Edit server/content/portfolio.ts to add, remove, reorder, or revise sections. The React frontend renders from /api/portfolio without hardcoded career content.",
  },
};
